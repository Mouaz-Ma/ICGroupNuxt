                ...
                <div class="col-xl-5 col-md-6">
                    <div class="mini-logo text-center my-4">
                         <NuxtLink class="nav-link" to="/"><img src="~/assets/images/logob.png" alt=""></NuxtLink>
                            <h4 class="card-title mt-3 mb-3 text-center">New News Form</h4>
                    </div>
                    <div class="auth-form card">
                        <div class="card-body">
                            <form @submit.prevent="uploadNews" class="row g-3" >
                                <div class="col-12">
                                ...
                                <div class="text-center">
                                    <button class="btn btn-primary btn-block">Upload a New News</button>
                                </div>
                            </form>
  ...
  methods: {
    ...
    async uploadNews() {
        try {
          ...
          let response = await this.$axios.post('/api/news/new', data);
