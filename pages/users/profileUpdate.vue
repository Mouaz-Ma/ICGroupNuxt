                    ...
                    <div class="header-right">
                        ...
                        <div class="profile_log dropdown">
                            <div class="user" data-toggle="dropdown">
                                <span class="thumb"><img src="~/assets/images/profile/1.png" alt=""></span>
...
<!-- 
    <div class="sidebar">
    <div class="brand-logo">
        <a href="index.html"><img src="~/assets/images/logoi.png" alt="" width="30">
        </a>
    </div>
    <div class="menu">
        <ul>
                                            ...
                                            <form>
                                                <div class="row g-3">
                                                    <div class="col-xxl-12">
                                                        ...
                                                        <input type="text" class="form-control" :placeholder=$auth.$state.user.username>
                                                    </div>
                                                    <div class="col-xxl-12">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <h4 class="mb-0">{{$auth.$state.user.username}}</h4>
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-xxl-6 col-xl-6 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            :value="$auth.$state.user.username" name="fullname">
                                                    </div>
                                                    <div class="col-xxl-6 col-xl-6 col-lg-6">
